...
wget https://raw.githubusercontent.com/gogogojason/files/master/common/files/etc/config/AdGuardHome.yaml ./devices/common/files/etc/config/AdGuardHome.yaml
rm -f ./devices/common/files/etc/config/mwan3
wget https://raw.githubusercontent.com/gogogojason/files/master/common/files/etc/config/mwan3 ./devices/common/files/etc/config/mwan3
find ./devices/common/.config -name "*bypass*" | xargs -i sed -i "s/bypass//g" {}
find ./devices/common/diy.sh -name "*GaryPang*" | xargs -i sed -i "s/bypass//g" {}
...
wget https://raw.githubusercontent.com/gogogojason/files/master/diy2.sh ./devices/common/diy2.sh
rm -f ./devices/common/settings.ini
wget https://github.com/gogogojason/files/blob/master/settings.ini ./devices/common/settings.ini
